...
### Changed
- README (en/ja): clarify that Kasumi is obfuscation, not encryption — document the 32-bit salt brute-force risk and the need for independent server-side authorization.
